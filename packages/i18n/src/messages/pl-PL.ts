export default {
  ...
  label: {
    ...
    uploader: {
      ...
      notConfigured: 'Przesyłanie nie jest skonfigurowane',
      tips: 'Przeciągnij pliki tutaj lub kliknij, aby je przesłać.',
  ...
  table: {
    ...
    insertLeft: 'Wstaw po lewej stronie',
