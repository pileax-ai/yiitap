export default {
  ...
  label: {
    ...
    uploader: {
      ...
      notConfigured: 'Функция загрузки не настроена.',
      tips: 'Перетащите файлы сюда или нажмите для загрузки.',
      uploading: 'Загрузка',
    },
    video: 'Видео',
  ...
  table: {
    ...
    insertBelow: 'Вставьте ниже',
    insertLeft: 'Вставить слева',
    insertRight: 'Вставьте правый',
