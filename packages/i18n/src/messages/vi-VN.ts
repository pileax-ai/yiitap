export default {
  ...
  label: {
    ...
    uploader: {
      ...
      notConfigured: 'Chức năng tải lên chưa được cấu hình.',
      tips: 'Kéo thả tệp vào đây hoặc nhấp chuột để tải lên.',
  ...
  table: {
    ...
    insert: 'Chèn bảng',
    insertAbove: 'Chèn vào phía trên',
    insertBelow: 'Chèn vào bên dưới',
    insertLeft: 'Chèn từ bên trái',
