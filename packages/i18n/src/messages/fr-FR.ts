export default {
  ...
  label: {
    ...
    uploader: {
      ...
      notConfigured: "Le chargement n'est pas configuré.",
      tips: 'Glissez-déposez les fichiers ici, ou cliquez pour les télécharger.',
